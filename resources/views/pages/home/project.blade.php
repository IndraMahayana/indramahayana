<section id="projects" class="relative overflow-hidden py-28
    ...
    <div
        class="absolute -top-40 -right-40 w-md h-112
        bg-sky-300/40 dark:bg-red-900/15
        blur-[160px] rounded-full">
    </div>

    <div
        class="absolute bottom-0 left-0 w-[24rem] h-96
        bg-blue-200/40 dark:bg-red-800/10
    ...
    <div class="relative z-10 text-center max-w-3xl mx-auto">
        ...
        <h2
            ...
            dark:drop-shadow-[0_10px_40px_rgba(0,0,0,0.9)]">
            Case Files
        </h2>
