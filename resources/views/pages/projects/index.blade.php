<x-layouts.app>
    ...
    <section id="projects" class="relative overflow-hidden py-32
        ...
        <div class="absolute -top-40 -right-40 w-120 h-120
                bg-red-900/20 blur-[160px] rounded-full">
        </div>

        <div class="absolute bottom-0 left-0 w-104 h-104
                bg-red-800/10 blur-[140px] rounded-full"></div>
        ...
        <div class="relative z-10 max-w-6xl mx-auto">
            ...
            <div class="mb-24">
                ...
                <div class="w-24 h-0.5 bg-red-800 mt-6"></div>

                <p class="mt-8 text-neutral-400 max-w-2xl leading-relaxed">
