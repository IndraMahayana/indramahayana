<x-layouts.app>
    ...
    opacity-[0.05] pointer-events-none">
        ...
        <div class="absolute -top-40 -left-40 w-md h-112
bg-red-900/15 blur-[160px] rounded-full">
        </div>

        <div class="absolute bottom-0 right-0 w-[24rem] h-96
    ...
    text-neutral-400 text-base sm:text-lg leading-relaxed">
                ...
                <div class="hidden md:grid grid-cols-2 gap-12">
                    ...
                    <div>
                        ...
                        <ul class="space-y-3 text-neutral-500 text-sm">
                            <li><a href="#" class="hover:text-red-700 transition">React</a></li>
                            <li><a href="#" class="hover:text-red-700 transition">Tailwind CSS</a></li>
                            <li><a href="#" class="hover:text-red-700 transition">Laravel</a></li>
                        </ul>
                    </div>

                    <div>
                        <h4 class="uppercase tracking-widest text-sm
                            text-neutral-300 mb-4">
                            Follow
                        </h4>
                        <ul class="space-y-3 text-neutral-500 text-sm">
                            <li><a href="#" class="hover:text-red-700 transition">Instagram</a></li>
                            <li><a href="#" class="hover:text-red-700 transition">LinkedIn</a></li>
                            <li><a href="#" class="hover:text-red-700 transition">GitHub</a></li>
                        </ul>
                    </div>
            ...
            <form action="{{ route('contact.send') }}" method="POST"
                ...
                <div>
                    ...
                    <input type="text" name="name" required
                        class="w-full bg-black/60 border border-neutral-700
                        text-neutral-200
                ...
                <div>
                    ...
                    <textarea name="message" rows="5" required
                        class="w-full bg-black/60 border border-neutral-700
                            text-neutral-200
                            px-4 py-3 rounded-lg
                            focus:outline-none focus:border-red-800"></textarea>
                </div>
        ...
        <div class="relative z-10 mt-24 max-w-7xl mx-auto">
            <div
                ...
                border border-neutral-800 grayscale contrast-125 brightness-75">
                <iframe title="Map"
